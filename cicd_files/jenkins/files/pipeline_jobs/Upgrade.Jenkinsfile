...
def bob = "bob/bob -r \${WORKSPACE}/cicd_files/jenkins/rulesets/Upgrade.yaml"
...
pipeline {
    ...
    stages {
        ...
        stage('Create and Switch to Production Context') {
            steps {
                sh "${bob} create-and-switch-to-production-context"
            }
        }
