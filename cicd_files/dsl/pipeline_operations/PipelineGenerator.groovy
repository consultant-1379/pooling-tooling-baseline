...
def pipelineBeingGeneratedName = 'resource-pooling-tool-baseline_Pipeline_Generator'

pipelineJob(pipelineBeingGeneratedName) {

    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName,
        "This ${pipelineBeingGeneratedName} job is used to generate initial RPT Baseline CICD pipelines and a CICD pipeline updater job",
