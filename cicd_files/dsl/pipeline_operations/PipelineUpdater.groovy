...
def pipelineBeingGeneratedName = 'resource-pooling-tool-baseline_Pipeline_Updater'

pipelineJob(pipelineBeingGeneratedName) {

    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName,
        "This ${pipelineBeingGeneratedName} job is used to update an already generated RPT baseline pipeline based on the changes to the master branch on gerrit.",
